...
def parse():
    ...
    # General options
    parser.add_argument('--genLine', dest='genLine', action='store_true',
                        help='Generate line map.')
    ...
    parser.add_argument('--backend', default='cudnn', type=str, help='backend',
                        choices=['cudnn', 'cunn'])
    parser.add_argument('--cudnn', default='fastest', type=str, help='cudnn setting',
                        choices=['fastest', 'deterministic', ' default'])
    # Path options
    parser.add_argument('--dataset', default='indoor', dest='dataset', type=str,
                        help='dataset name')
    ...
    parser.add_argument('--trainPctg', default=0.95, type=float,
                        help='Percentage of training images')
    parser.add_argument('--imgDim', default=320, type=int, help='Image dimension')
    # Training/testing options
    parser.add_argument('--nEpochs', default=200, type=int, help='Number of total epochs to run')
    parser.add_argument('--epochNum', default=-1, type=int, help='0=retrain | -1=latest | -2=best',
                        choices=[0, -1, -2])
    ...
    parser.add_argument('--testOnly', default=False, type=str2bool,
                        help='Run the test to see the performance')
    parser.add_argument('--barwidth', default=50, type=int, help='Progress bar width')
    parser.add_argument('--visTrain', default=15, type=int, help='Visualizing training examples')
    parser.add_argument('--visTest', default=15, type=int, help='Visualizing testing examples')
    parser.add_argument('--visWidth', default=1, type=int,
                        help='Number of images per row for visualization')
    parser.add_argument('--visThres', default=0.05, type=float, help='Threshold for visualization')
    # Optimization options
    parser.add_argument('--LR', default=0.001, type=float, help='initial learning rate')
    parser.add_argument('--LRDecay', default='exp', type=str, help='LRDecay method')
    parser.add_argument('--LRDParam', default=100, type=int, help='param for learning rate decay')
    ...
    # Model options
    parser.add_argument('--netType', default='stackedHGB', type=str,
                        help='Your defined model name')
    ...
    parser.add_argument('--nStack', default=5, type=int, help='Number of hourglasses to stack')
    parser.add_argument('--nModules', default=2, type=int,
                        help='Number of residual modules at each location in the hourglass')
    parser.add_argument('--nOutChannels', default=64, type=int, help='Number of output channels')
    # Other model options
